...
import dao.AsignaturaAlumnoDAO;

/**
 *
 * @author luisp
 */
public class MySQL_AsignaturaAlumno implements  AsignaturaAlumnoDAO  {
    private List<AlumnoAsignatura> listaAsignaturas;
    private String query;
    MySQL_Conexion c;
     private ResultSet rs;

    public MySQL_AsignaturaAlumno() throws ClassNotFoundException, SQLException {
    ...
    public void create(AlumnoAsignatura a) {
        try {
            ...
            Logger.getLogger(MySQL_AsignaturaAlumno.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
